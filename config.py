...
KGGEN_MODEL = os.getenv("KGGEN_MODEL", "gemini/gemini-2.5-flash")
...
def kggen_api_key() -> str | None:
    ...
    if model.startswith("gemini/") or model.startswith("google/") or model.startswith("vertex_ai/"):
        return GEMINI_API_KEY
    return GEMINI_API_KEY or OPENAI_API_KEY or ANTHROPIC_API_KEY
